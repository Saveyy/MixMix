...
namespace Security
{
    public static class UserSecurity //https://stackoverflow.com/questions/4181198/how-to-hash-a-password/10402129#10402129
    {
        ...
        public static string GenerateHashedPassword(string password, out string salt)
        {
            ...
            new RNGCryptoServiceProvider().GetBytes(saltArray);
